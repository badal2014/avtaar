...
import imageMaria from '../images/maria.png'
    ...
    render(){
        ...
        <div className="chat-box">
               ...
               <div className="row m0 pad-top-10 pad-bot-0 p-r-l-15">
                  ...
                  <div className="col-md-9 ">
                        <div className="align-items-center side-prile-box">
                            ...
                            <p className="msg-text">Hey robin,this seems like a great start
            ...
            <div className="col-md-12 pad-top-10 pad-bot-0 ">
               <div className="row m0">
               <div className="col-md-2 avatar avatar-sm rounded-circle p-l-r-0">
                    <img src={imageMaria}  width="40" height="40" alt="profile" />
                </div>
            ...
            {/* ======== */}
             ...
             <div className="col-md-12 pad-top-10 pad-bot-0">
               <div className="row m0">
                  <div className="col-md-2 avatar avatar-sm rounded-circle p-l-r-0">
                        <img src={imgGirl}  width="40" height="40" alt="profile" />
                  </div>
                  <div className="col-md-8 ">
                        <div className="align-items-center side-prile-box">
